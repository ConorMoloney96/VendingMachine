   ...
   */
   public void run(VendingMachine machine) throws IOException
   {
      ...
      { 
		 ...
		 //termines the while loop and quits the menu
   ...
   //method which displays every element in an array of objects and allows the user to select one of the objects which is then returned
